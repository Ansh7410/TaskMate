...
const AnalyticsDashboard = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-100 min-h-screen space-y-8">
      {/* Monthly Progress */}
      <div className="rounded-xl shadow-md overflow-hidden">
        <div className="bg-gray-800 text-white px-4 sm:px-6 py-3 font-semibold text-lg flex justify-between items-center">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="rounded-xl shadow-md overflow-hidden flex-1">
          <div className="bg-gray-700 text-white px-6 py-3 font-semibold text-lg text-center">
            Current Streak
          </div>
      ...
      {/* Habit Distribution */}
      <div className="rounded-xl shadow-md overflow-hidden">
        <div className="bg-gray-700 text-white px-6 py-3 font-semibold text-lg">
          Habit Distribution
        </div>
      ...
      <div className="rounded-xl shadow-md overflow-hidden">
        ...
        <div className="bg-white p-4 sm:p-6 overflow-x-auto">
          <div className="inline-grid grid-cols-7 gap-2">
            ...
            {heatmap.flat().map((day, index) => (
              <div
                key={index}
                className={`w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center border rounded-lg ${
                  day === "✔"
